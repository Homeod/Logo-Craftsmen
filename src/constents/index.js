  ...
  const faqs = [
    {
      ...
      answer:"The turnaround time can vary based on the complexity of the project. Generally, we aim to deliver initial logo concepts within same day. The total duration depends on the number of revisions and client feedback. We strive to meet your deadlines and can provide estimated timelines during the initial consultation.",
    },
    {
